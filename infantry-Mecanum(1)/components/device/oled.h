...
extern OLED_GRAM_strutct_t oled_gram;
...
/**
  ...
  * @retval         none
  */
extern void OLED_display_turn(void);
 ...
 * @retval  None
 */
extern void OLED_show_char(uint8_t row, uint8_t col, char chr);
 ...
 * @retval  None
 */
extern void OLED_show_string(uint8_t row, uint8_t col, char *chr);
