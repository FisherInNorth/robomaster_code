			 ...
			 if(dma_rx_buff[j] == ';')//结束接收
				{
					...
					L_move_flag=(int16_t)(receive_data[3]<<8|receive_data[2]);			
...
{ 
	...
	Sent_dataC=100*gimbal_y.IMU_actual_speed;
	Sent_dataD=100*gimbal_p.IMU_actual_speed;
//	send_data.data[0] = (Sent_dataA*100);
//	send_data.data[1] = (Sent_dataB*100);
//	send_data.data[2] = (gimbal_y.IMU_actual_speed*100);
//	send_data.data[3] = (gimbal_p.IMU_actual_speed*100);
//	send_data.data[4] = (vision_actual_speed*100);
//	send_data.data[5] = (vision_actual_angle*100);
