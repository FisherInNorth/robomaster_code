...
/*四个底盘电机的速度环pid参数*/
float ChassisMotor1_PID_Parameters[6] = {8.0, 1.2, 0.5, 10000, 10000, 10000};
float ChassisMotor2_PID_Parameters[6] = {8.0, 1.2, 0.5, 10000, 10000, 10000};
float ChassisMotor3_PID_Parameters[6] = {8.0, 1.2, 0.5, 10000, 10000, 10000};
float ChassisMotor4_PID_Parameters[6] = {8.0, 1.2, 0.5, 10000, 10000, 10000};

/*两个外侧抬升电机的速度环和角度环pid参数*/
float Outboard_MotorL_vPID_Parameters[6] = {0.5		, 0.5	, 5 , 10000, 10000 , 4500};
float Outboard_MotorL_aPID_Parameters[6] = {0.1	, 0.1	, 0 , 10000, 100	 , 1000};

float Outboard_MotorR_vPID_Parameters[6] = {0.5		,	0.5	, 5 , 10000, 10000 , 4500};
float Outboard_MotorR_aPID_Parameters[6] = {0.1	, 0.1	, 0 , 10000, 100	 , 1000};
