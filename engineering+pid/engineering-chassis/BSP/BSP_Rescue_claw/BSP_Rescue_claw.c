...
void Claw_Init(void)
{
	...
	claw_L_motor.vpid.err=0;
	claw_L_motor.vpid.last_err=0;
	claw_L_motor.vpid.err_integration=0;
	claw_L_motor.vpid.P_OUT=0;
	claw_L_motor.vpid.I_OUT=0;
	claw_L_motor.vpid.D_OUT=0;
	claw_L_motor.vpid.PID_OUT=0;
	...
	claw_R_motor.vpid.err=0;
	claw_R_motor.vpid.last_err=0;
	claw_R_motor.vpid.err_integration=0;
	claw_R_motor.vpid.P_OUT=0;
	claw_R_motor.vpid.I_OUT=0;
	claw_R_motor.vpid.D_OUT=0;
	claw_R_motor.vpid.PID_OUT=0;
}
...
{
	Vpid_Realize(claw_L_motor, kp, ki, kd);
	Vpid_Realize(claw_R_motor, kp, ki, kd);
...
void Set_Claw_Current()
{
	...
	//can发送数据帧
//	CAN1_Send_Claw_Msg(current_msg);
}
