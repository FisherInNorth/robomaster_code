...
float Longitudinal_MotorL_vPID_Parameters[6] = {10	,	0.05	, 0 , 10000, 10000 , 9000};
float Longitudinal_MotorL_aPID_Parameters[6] = {1	, 0	, 0 , 10000, 10000	 , 500};
...
float Inside_MotorL_vPID_Parameters[6] = { 20 ,	0.01	, 0 , 10000, 10000 , 15000};
float Inside_MotorL_aPID_Parameters[6] = {0.5	, 0	, 0, 10000, 100	 , 1000};

float Inside_MotorR_vPID_Parameters[6] = { 20 ,	0.01	, 0 , 10000, 10000 , 15000};
...
//float horizontal_motor_aPID_Parameters[6]={2	, 0.1	, 10 , 10000, 100	 , 1000};
float horizontal_motor_vPID_Parameters[6]={2	,	1.5	, 10 , 10000, 1000 , 9000};
float horizontal_motor_aPID_Parameters[6]={2	,	0.8	, 10 , 10000, 100 , 2000};

/*吸盘yaw的速度环和角度环pid参数*/
float chuck_yaw_vPID_Parameters[6] = {0.8	,	0.105	, 0 , 10000, 10000 , 6000};
float chuck_yaw_aPID_Parameters[6] = {0.45, 0	, 70 , 10000, 100	 , 4000};
...
void ChuckRoll_PID_Calc(MOTOR_t *motor, float * aPID_Parameters, float * vPID_Parameters)
{
	...
	motor->vpid.target_speed = motor->apid.PID_OUT;
//	motor->vpid.target_speed = target_speed;
