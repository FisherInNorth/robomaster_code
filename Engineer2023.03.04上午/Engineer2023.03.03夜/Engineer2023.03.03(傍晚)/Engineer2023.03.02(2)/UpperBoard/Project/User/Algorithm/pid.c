...
/*吸盘yaw的速度环和角度环pid参数*/
float chuck_yaw_vPID_Parameters[6] = {0.5	,	0.5	, 0 , 10000, 10000 , 10000};
float chuck_yaw_aPID_Parameters[6] = {0.5	, 0	, 70 , 10000, 100	 , 1000};
/*吸盘pitch的速度环和角度环pid参数*/
float chuck_pitch_vPID_Parameters[6] = {0.25	,	0.25	, 0 , 10000, 10000 , 5000};
float chuck_pitch_aPID_Parameters[6] = {0.25	, 0	, 30 , 10000, 100	 , 1000};
/*吸盘roll的速度环和角度环pid参数*/
float chuck_roll_vPID_Parameters[6] = {0.25	,	0	, 0 , 10000, 10000 , 5000};
float chuck_roll_aPID_Parameters[6] = {0.25	, 0	, 0 , 10000, 100	 , 1000}; 
