...
float Outboard_MotorL_vPID_Parameters[6] = {0.5	,	0.5	, 0 , 10000, 10000 , 10000};
float Outboard_MotorL_aPID_Parameters[6] = {1	, 0	, 100 , 10000, 100	 , 1000};

float Outboard_MotorR_vPID_Parameters[6] = {0.5	,	0.5	, 0 , 10000, 10000 , 10000};
float Outboard_MotorR_aPID_Parameters[6] = {1	, 0	, 100 , 10000, 100	 , 1000};
