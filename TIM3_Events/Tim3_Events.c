...
void Robo_Move()
{
  ...
  apid_card_realize(a_card_p,a_card_i,a_card_d);
	...
	vpid_rescue_realize(v_resuce_p,v_resuce_i,v_resuce_d);
	vpid_mineral_longitudinal_realize(v_mineral_p,v_mineral_i,v_mineral_d);		
	vpid_mineral_widthwise_realize(v_mineral_p,v_mineral_i,v_mineral_d);		
  /*------ 电流赋值 ------*/	
	set_chassis_current();	
	set_handle_current();
	set_flip_current();
